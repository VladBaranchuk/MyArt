...
namespace MyArt.DataAccess.Migrations
{
    ...
    [Migration("20220502170351_addDataPropToUser")]
    partial class addDataPropToUser
    {
            ...
            modelBuilder.Entity("MyArt.Domain.Entities.Art", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2022, 5, 2, 20, 3, 51, 63, DateTimeKind.Local).AddTicks(1885));
            ...
            modelBuilder.Entity("MyArt.Domain.Entities.Board", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 2, 20, 3, 51, 65, DateTimeKind.Local).AddTicks(1956));
